...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            if (code_id != "") {
                $.ajax({
//                    url: 'https://captainindiatest2.anekalabs.com/backend/index.php/api/qrcodedetailbycode/'+code_id,
                    url: 'http://localhost/captain-india-phase-2/backend/index.php/api/qrcodedetailbycode/'+code_id,
                    data: {action: 'test'},
                    type: 'post',
...
//                    url:  'https://captainindiatest2.anekalabs.com/backend/index.php/api/addQrCodeScanAlert',
                    url:  'http://localhost/captain-india-phase-2/backend/index.php/api/addQrCodeScanAlert',
        ...
        function sendOtp() {
            ...
            if (mobile_no.length != 10) {
                ...
                $.ajax({
                    ...
                    url: "https://captainindiatest2.anekalabs.com/backend/index.php/api/sendotpqrcode",
                    success: function (data) {
                        $("#mobile_no_div").hide();
                        $("#send_otp_div").show();
                    }
        ...
        function verifyOtp() {
            ...
            if (otp.length != 4) {
                ...
                $.ajax({
                    ...
                    url: "https://captainindiatest2.anekalabs.com/backend/index.php/api/verifyotpsdqrcode",
                    success: function (data) {
